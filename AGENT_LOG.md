...
- [P47] Added `GET /breaking-news`, which reads the five newest incident timeline entries by descending `entry_id`, loads their incident bodies, and returns them in insertion order for the frontend banner. Added service and route coverage plus endpoint documentation.
